...
const SequenceInstrument kBgmInstruments[12]{
    ...
    {Timbre{&pixel_twins::kStandardWaves.thinPulse, Envelope{0.004F, 0.045F, 0.66F, 0.055F}, 0.052F, -0.28F}, 1.00405F},
    {Timbre{&pixel_twins::kStandardWaves.bell, Envelope{0.002F, 0.11F, 0.32F, 0.16F}, 0.14F, -0.1F}},
    {Timbre{&pixel_twins::kStandardWaves.sine, Envelope{0.001F, 0.075F, 0.08F, 0.05F}, 0.40F}, 1.0F, 72.0F, 0.53F, 0.09F},
    ...
    {Timbre{&pixel_twins::kStandardWaves.noise, Envelope{0.001F, 0.035F, 0.08F, 0.04F}, 0.13F}, 1.0F, 140.0F},
    {Timbre{&pixel_twins::kStandardWaves.noise, Envelope{0.001F, 0.035F, 0.08F, 0.04F}, 0.13F}, 1.0F, 680.0F},
    {Timbre{&pixel_twins::kStandardWaves.noise, Envelope{0.001F, 0.035F, 0.08F, 0.04F}, 0.13F}, 1.0F, 240.0F},
};
